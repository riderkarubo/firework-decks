 ...
 * 5. TITLE を資料タイトルに変える
 *
 * 「パスワードを記憶する」チェック ON → localStorage（ブラウザを閉じても維持）
...
(function () {
  ...
  function buildGate() {
    ...
    s.textContent = [
      '#fw-gate{position:fixed;inset:0;z-index:99999;background:#1A1A2E;display:flex;align-items:center;justify-content:center;font-family:"Noto Sans JP",sans-serif;padding:24px;}',
